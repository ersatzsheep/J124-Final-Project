...
In summary, my data analysis identified Nevada, Trinity, and Mariposa as the counties with the highest vaccination exemption rates in 2015. Additionally, Trinity and Nevada had the lowest vaccination rates for MMR, DTP, and Polio in 2015. Finally, Nevada was among the counties with the highest standard deviation in completed vaccination for MMR, DTP, and Polio in 2015. From these results, the recurrence of Nevada County emerges as a potential lead.

Nevada County is a point of interest due to its relatively lower vaccination rate, higher vaccination exemption rate, and higher standard deviation in completed vaccinations based on immunization records for California kindergarteners in 2015. These identified trends lead me to believe that Nevada County experiences unique barriers to vaccination. My investigation will involve identifying these barriers, outlining why they exist, and writing a solutions-based article to improve vaccine accessibility in Nevada County.

Are people hesitant to receive vaccinations? If so, why? Is there a deep-rooted historical rationale? Is it due to religious beliefs? Are there medical conditions that disproportionately affect this community and warrant increased medical exemptions? Or, are these trends due to deficits in physical access to vaccines? Are there limited nearby medical facilities? Are there monetary barriers that discourage vaccinations? These questions will be investigated by visiting Nevada County and interviewing locals. Recording anecdotes from those who have not completely vaccinated their kindergarteners is essential to contextualize the trends found in the data. After understanding the root of the problem, I want to compare Nevada County’s Covid-19 vaccination rates to the rest of the state and nation to see if the same barriers have carried over to the pandemic, during a time in which being vaccinated could easily determine life or death for vulnerable individuals.
